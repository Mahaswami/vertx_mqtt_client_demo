...
public class Runner {
  ...
  private static final String RX_EXAMPLES_DIR = "/home/msuser1/vertx/mqttex";
  ...
  public static void runExample(String exampleDir, Class clazz, VertxOptions options, DeploymentOptions
    ...
    runExample(exampleDir + clazz.getName().replace(".", "/"), clazz.getName(), options, deploymentOptions);
  }
